...
public class NhanVienJDialog extends javax.swing.JDialog {
    ...
    void insert() {
        ...
        DataValidator.validateEmpty(txtMatKhau2, sb, "Vui lòng xác nhận mật khẩu!");
        DataValidator.validateEmpty(txtHoTen, sb, "Vui lòng nhập họ và tên nhân viên!");
        if (sb.length() > 0) {
        ...
        if (confirm.equals(model.getMatKhau())) {
            ...
            txtMatKhau2.setBackground(Color.yellow);
    ...
    private void initComponents() {
        ...
        tblNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ NHÂN VIÊN", "HỌ TÊN", "MẬT KHẨU", "VAI TRÒ"
            }
        ));
